...
class IDAG_M3_KD3(nn.Module): #hardcode
    def __init__(self, scale=2):
        super(IDAG_M3_KD3, self).__init__()
        ...
        self.conv.append(nn.Conv2d(32, 16, 1, 1, 0)) #4a
        self.conv.append(nn.Conv2d(16, 16, 3, 1, 1)) #4b
        self.conv.append(nn.Conv2d(16, 32, 1, 1, 0)) #4c
        
        self.conv.append(nn.Conv2d(32, 16, 1, 1, 0)) #5a
        self.conv.append(nn.Conv2d(16, 16, 3, 1, 1)) #5b
        self.conv.append(nn.Conv2d(16, 32, 1, 1, 0)) #5c
