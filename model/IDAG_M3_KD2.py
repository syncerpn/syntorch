...
class IDAG_M3_KD2(nn.Module): #hardcode
    def __init__(self, scale=2):
        super(IDAG_M3_KD2, self).__init__()
        ...
        self.conv.append(nn.Conv2d(32,  8, 1, 1, 0)) #2a
        self.conv.append(nn.Conv2d( 8,  8, 3, 1, 1)) #2b
        self.conv.append(nn.Conv2d( 8, 32, 1, 1, 0)) #2c
        
        self.conv.append(nn.Conv2d(32,  8, 1, 1, 0)) #3a
        self.conv.append(nn.Conv2d( 8,  8, 3, 1, 1)) #3b
        self.conv.append(nn.Conv2d( 8, 32, 1, 1, 0)) #3c
        
        self.conv.append(nn.Conv2d(32,  8, 1, 1, 0)) #4a
        self.conv.append(nn.Conv2d( 8,  8, 3, 1, 1)) #4b
        self.conv.append(nn.Conv2d( 8, 32, 1, 1, 0)) #4c
        
        self.conv.append(nn.Conv2d(32,  8, 1, 1, 0)) #5a
        self.conv.append(nn.Conv2d( 8,  8, 3, 1, 1)) #5b
        self.conv.append(nn.Conv2d( 8, 32, 1, 1, 0)) #5c
