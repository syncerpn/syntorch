...
class LargeModule(nn.Module):
    def __init__(self):
        ...
        self.conv.append(nn.Conv2d(64, 64, 3, 1, 1)) #2a
...
class SmallModule(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.ModuleList()
        self.conv.append(nn.Conv2d(64, 4, 1, 1, 0)) #2a
        self.conv.append(nn.Conv2d(4, 64, 3, 1, 1)) #2a
...
class FusionNet_9(nn.Module): #hardcode
    def __init__(self, scale=2):
        super(FusionNet_9, self).__init__()
