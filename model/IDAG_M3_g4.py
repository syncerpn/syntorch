...
class IDAG_M3_g4(nn.Module): #hardcode
    def __init__(self, scale=2):
        super(IDAG_M3_g4, self).__init__()
        ...
        self.conv.append(nn.Conv2d(32, 32, 3, 1, 1, groups=4)) #2
        self.conv.append(nn.Conv2d(32, 32, 3, 1, 1, groups=4)) #3
        self.conv.append(nn.Conv2d(32, 32, 3, 1, 1, groups=4)) #4
        self.conv.append(nn.Conv2d(32, 32, 3, 1, 1, groups=4)) #5
