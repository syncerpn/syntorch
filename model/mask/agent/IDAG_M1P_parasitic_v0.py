...
class IDAG_M1P_parasitic_v0(nn.Module):
    def __init__(self, target_layer_index, immc=4):
        super(IDAG_M1P_parasitic_v0, self).__init__()
        self.immc = immc
        ...
        for l in self.target_layer_index:
            if l == 1:
                self.agent_list[l] = module.unit_agent_uni_1x1(32, 16, 0, immc)
            elif l == 6:
                self.agent_list[l] = module.unit_agent_uni_1x1(16, 32, 0, immc)
            else:
                self.agent_list[l] = module.unit_agent_mix_1x1_3x3(16, 16, 0, immc)
